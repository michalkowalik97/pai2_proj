...
class RegisterControllerTest {
    ...
    @Test
    void should_not_register_email() throws  Exception {
        RegisterDTO registerDTO = new RegisterDTO();
        registerDTO.setAddress("TESTADDRESS");
        registerDTO.setEmail("testmail");
        registerDTO.setUsername("TESTUSERNAME12345");
        registerDTO.setPassword("12345");
        registerDTO.setPhone("123456789");
        mockMvc.perform(post("/api/register")
    ...
    @Test
    void should_not_register_username() throws  Exception {
        RegisterDTO registerDTO = new RegisterDTO();
        registerDTO.setAddress("TESTADDRESS");
        registerDTO.setEmail("TESTEMAIL222333");
        registerDTO.setUsername("testingonlyuser");
        registerDTO.setPassword("12345");
        registerDTO.setPhone("123456789");
        mockMvc.perform(post("/api/register")
                .content(objectMapper.writeValueAsString(registerDTO))
